...
import br.net.rafaeltuelho.jb297.unit2.model.PolicyHolder;
import br.net.rafaeltuelho.jb297.unit2.model.PolicyHolder_;
...
public class PolicyHolderEntityTest {
	...
	private static final String[] MOCK_DATA = { "PH 1", "PH 2", "PH 3" };
